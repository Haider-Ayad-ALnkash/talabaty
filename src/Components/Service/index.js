                    ...
                    <div className="container">
                        <div className="row text-center">
                            ...
                            <div className="col-sm-6 col-md-4 card">
                                <img src="/images/همبركر.jpg" className="card-img-top" alt="..."/>
                                <div className="card-body">
                            ...
                            <div className="col-sm-6 col-md-4 card">
                                <img src="/images/صاج.jpg" className="card-img-top" alt="..."/>
                                <div className="card-body">
                                    <h2 className="card-title">سندويش</h2>
                            ...
                            <div className="col-sm-6 col-md-4 card">
                                <img src="/images/مقبلات.jpg" className="card-img-top" alt="..."/>
                                <div className="card-body">
